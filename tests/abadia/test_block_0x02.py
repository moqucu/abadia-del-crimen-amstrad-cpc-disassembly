#!/usr/bin/env python3
"""
Test Block 0x02 - "thin red brick parallel to x"
"""
import os
import sys
...
print("="*80)
print("BLOCK 0x02 - 'thin red brick parallel to x'")
print("="*80)
...
print(f"Tile data: {[f'0x{t:02X}' for t in block_def.tile_data[:6]]}")
...
test_cases = [
    ...
    (3, 2, "param1=3, param2=2"),
    (1, 7, "param1=1, param2=7 (from Room 0)")
]
...
for param1, param2, desc in test_cases:
    ...
    # Save result
    output = f'block_0x02_p1_{param1}_p2_{param2}.png'
    canvas.save(output)
