#!/usr/bin/env python3
"""
Test Block 0x06 - with tile tracing
"""
import os
import sys
...
print("="*80)
print("BLOCK 0x06 TEST")
print("="*80)

# Get Block 0x06
# IMPORTANT FINDING: This block renders windows with TWO different heights:
...
# This creates architectural variety in the wall with mixed window sizes.
...
test_cases = [
    (2, 6, "Room 0 usage #1: params=(2,6)"),
    (2, 1, "Room 0 usage #2: params=(2,1)"),
]
...
for param1, param2, desc in test_cases:
    ...
    # Save result
    output = f'block_0x06_p1_{param1}_p2_{param2}.png'
    canvas.save(output)
    print(f"Saved: {output}")

print("\n" + "="*80)
print("GENERATED FILES:")
print("  block_0x06_p1_2_p2_6.png")
print("  block_0x06_p1_2_p2_1.png")
print("="*80)
