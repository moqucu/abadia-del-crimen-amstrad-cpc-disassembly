#!/usr/bin/env python3
"""
Test Block 0x04 - with tile tracing
"""
import os
import sys
...
print("="*80)
print("BLOCK 0x04 TEST")
print("="*80)

# Get Block 0x04
block_def = BLOCK_DEFINITIONS[0x04]
...
test_cases = [
    (2, 4, "Room 0 usage #1: params=(2,4)"),
    (0, 1, "Room 0 usage #2: params=(0,1)"),
]
...
for param1, param2, desc in test_cases:
    ...
    # Save result
    output = f'block_0x04_p1_{param1}_p2_{param2}.png'
    canvas.save(output)
    print(f"Saved: {output}")

print("\n" + "="*80)
print("GENERATED FILES:")
print("  block_0x04_p1_2_p2_4.png")
print("  block_0x04_p1_0_p2_1.png")
print("="*80)
