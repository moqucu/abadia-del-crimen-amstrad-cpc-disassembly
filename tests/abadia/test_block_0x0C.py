#!/usr/bin/env python3
"""
Test Block 0x0C - with tile tracing
"""
import os
import sys
...
for param1, param2, desc in test_cases:
    ...
    # Save result
    output = f'block_0x0C_p1_{param1}_p2_{param2}.png'
    canvas.save(output)
    print(f"Saved: {output}")

print("\n" + "="*80)
print("GENERATED FILES:")
print("  block_0x0C_p1_1_p2_1.png")
print("="*80)
